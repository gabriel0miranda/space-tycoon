return {
  ...
  HOSTILE_DETECT_RANGE = 3000,
  MOUSE_FADE_TIMER = 5,
  ASTEROID_MIN_RADIUS = 4000,
  ASTEROID_MAX_RADIUS = 10000,
  ...
  DumpTable = require("utils.dump_table"),
  ...
  PulseSystem = require("systems.pulse_system"),
  DamageSystem = require("systems.damage_system"),
  ...
  AutopilotSystem = require("systems.autopilot_system"),
  ...
  AIComponent = require("components.ai"),
  HullComponent = require("components.hull"),
  AutopilotComponent = require("components.autopilot"),
