...
local buttons = {
    { key = "1", label = "Menu",      action = "menu", danger = false },
    { key = "2", label = "Sair",      action = "quit", danger = true  },
}
...
function Dead.mousepressed(mx, my, button)
...
function Dead.wheelmoved(dx, dy)
end
